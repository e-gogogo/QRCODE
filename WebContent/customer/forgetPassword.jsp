    ...
    function getVerificationCode(){
		...
		if (!pa2.test(mail)) {
			...
			$.ajax({
    	        ...
    	        data: {Cmail:mail},//data是传给后台的字段，后台需要哪些就传入哪些
    ...
    function verify(){
		...
		if (!pa2.test(mail)) {
			...
			$.ajax({
    	        ...
    	        data: {Cmail:mail,Code:code},//data是传给后台的字段，后台需要哪些就传入哪些
    	        success: function(data){
...
<center>
		<div id="main_body">
			<div id="main_forgetPassword">
							邮箱：<input type="text" id = "Cmail" value = ""/><br><br>
							<input type="text" id = "VerificationCode" value = ""/><br><br>
